    ...
    >
      ...
      >
        ...
        <div className="flex bg-[#0d1017] border-b border-[#1e2330] overflow-x-auto">
          <div
            className="flex items-center gap-1.75 text-[12.5px] px-4.5 py-2.75 text-[#d7dae0] bg-[#12161f] border-r border-[#1e2330] border-t-2 border-t-[#7aa2f7] whitespace-nowrap"
            style={{ fontFamily: 'var(--font-mono)' }}
          >
            <span className="w-1.75 h-1.75 rounded-full bg-[#7aa2f7]" />
            about.tsx
          </div>
          <div
            className="flex items-center gap-1.75 text-[12.5px] px-4.5 py-2.75 text-[#565d6b] border-r border-[#1e2330] whitespace-nowrap"
            style={{ fontFamily: 'var(--font-mono)' }}
          >
            <span className="w-1.75 h-1.75 rounded-full bg-[#e0af68]" />
            skills.json
          </div>
          <div
            className="flex items-center gap-1.75 text-[12.5px] px-4.5 py-2.75 text-[#565d6b] whitespace-nowrap"
            style={{ fontFamily: 'var(--font-mono)' }}
          >
            <span className="w-1.75 h-1.75 rounded-full bg-[#9ece6a]" />
            philosophy.md
          </div>
        </div>
        ...
        <div className="grid grid-cols-[32px_1fr] sm:grid-cols-[46px_1fr]">
          ...
          <div className="px-4.5 sm:px-8 py-7 pb-9">
            <div
            ...
            <h3
              className="font-extrabold text-[#f2f4f8] leading-tight mb-4 text-[26px] sm:text-[32px] md:text-[40px] tracking-tight"
              style={{ fontFamily: 'var(--font-sans)' }}
            >
           ...
           <p className="text-[#9aa1af] text-[13px] sm:text-[14.5px] leading-[1.85] mb-3 max-w-160">
  I&apos;m a{' '}
...
<p className="text-[#9aa1af] text-[13px] sm:text-[14.5px] leading-[1.85] mb-6 max-w-160">
  ...
  with attention to detail, clean code, and user experience.
            ...
            <div
              className="flex flex-wrap gap-2.25 mb-6"
              style={{ fontFamily: 'var(--font-mono)' }}
            >
              {[
                ...
                <span
                  key={item.label}
                  className={`text-[12px] px-3.25 py-1.5 rounded-[7px] bg-[#151a24] border border-[#232a38] ${item.color}`}
                >
                  {item.label}
                </span>
              ))}
        ...
        <div
          className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 sm:gap-0 px-4.5 sm:px-8 py-3 bg-[#10131b] border-t border-[#1e2330] text-[10.5px] sm:text-[11px] text-[#565d6b]"
          style={{ fontFamily: 'var(--font-mono)' }}
        >
          <span className="flex items-center gap-1.75 text-[#9ece6a]">
            <span className="w-1.75 h-1.75 rounded-full bg-[#9ece6a] animate-pulse" />
